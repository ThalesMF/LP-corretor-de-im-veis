        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            <img
              src={logoImg}
              alt="Logo"
              className="w-11 h-11 rounded-full object-cover group-hover:scale-105 transition-transform duration-200 shadow-sm"
            />
            <div>
            ...
            {navLinks.map(function (link) {
              ...
              return (
                <Link
                  key={link.path}
                  to={link.path}
                  className={`text-sm font-medium transition-all duration-300 ease-in-out py-1 border-b-2 hover:-translate-y-0.5 ${
                    active
