...
import logoImg from "../assets/logocortada.png";
    ...
    <footer className="bg-brand-dark text-white border-t border-brand-border/20 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-white/70 text-sm leading-relaxed max-w-sm">
              Assessoria imobiliária humanizada, transparente e especializada em
              Granja e nas principais regiões turísticas e residenciais do
              litoral do Ceará.
            </p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/50">
          <p>
            © {currentYear} João Silva — Corretor de Imóveis • CRECI 00000-F.
